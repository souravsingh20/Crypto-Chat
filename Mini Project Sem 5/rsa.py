...
print(" Welcome to Crypto Chat's RSA ENCRYPTOR/DECRYPTOR")
print("*****************************************************")
 
# print("The Prime Numbers 'p' and 'q' are")
p = 733
q = 347
...
#Message
message = input("What would you like encrypted or decrypted, Enter your message!?(Separate numbers with ',' for decryption): ")
